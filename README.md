## pmb2_simulation (humble) - 4.11.1-1

The packages in the `pmb2_simulation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble pmb2_simulation -y` on `Wed, 11 Feb 2026 08:56:13 -0000`
...
## pmb2_simulation (humble) - 4.9.1-1

The packages in the `pmb2_simulation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble pmb2_simulation -y` on `Fri, 31 Oct 2025 07:32:27 -0000`
...
## pmb2_simulation (humble) - 4.8.0-1

The packages in the `pmb2_simulation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble pmb2_simulation -y` on `Wed, 18 Jun 2025 14:12:32 -0000`
...
## pmb2_simulation (humble) - 4.7.0-1

The packages in the `pmb2_simulation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble pmb2_simulation -y` on `Tue, 13 May 2025 11:56:37 -0000`
...
- upstream repository: https://github.com/pal-robotics/pmb2_simulation.git
- release repository: https://github.com/pal-gbp/pmb2_simulation-release.git
- rosdistro version: `4.0.16-1`
- old version: `4.0.16-1`
- new version: `4.1.0-1`
...
## pmb2_simulation (humble) - 4.0.16-1

The packages in the `pmb2_simulation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble pmb2_simulation -y` on `Tue, 09 Jul 2024 07:50:29 -0000`
...
- upstream repository: https://github.com/pal-robotics/pmb2_simulation.git
- release repository: https://github.com/pal-gbp/pmb2_simulation-release.git
- rosdistro version: `4.0.14-1`
- old version: `4.0.14-1`
- new version: `4.0.16-1`
...
## pmb2_simulation (humble) - 4.0.14-1

The packages in the `pmb2_simulation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble pmb2_simulation` on `Fri, 28 Jun 2024 11:44:09 -0000`
...
## pmb2_simulation (humble) - 4.0.11-1

The packages in the `pmb2_simulation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble pmb2_simulation -y` on `Tue, 18 Jun 2024 10:22:06 -0000`
...
## pmb2_simulation (humble) - 4.0.6-1
